...
function(_generator_parse_platform manifest version target)
    ...
    elseif(os STREQUAL "apple" AND env STREQUAL "darwin")
        ...
        find_library(MACOS_SYSTEM System)
        if (NOT MACOS_SYSTEM)
            message(FATAL_ERROR "System Library not found")
        else()
            message(STATUS "MACOS System library is: ${MACOS_SYSTEM}")
        endif()

        if(NOT COR_NO_STD)
           list(APPEND libs "resolv" "c" "m" "${MACOS_SYSTEM}")
        endif()
...
function(_generator_add_target manifest ix cargo_version profile)
    ...
    if(is_macos)
        corrosion_add_target_rustflags(TARGET ${target_name} "-L/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib")
    endif()
