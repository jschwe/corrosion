...
function(_generator_add_target manifest ix cargo_version profile)
    ...
    if(NOT (is_library OR is_executable))
        message(FATAL_ERROR "unknown target type")
    endif()
...
function(_generator_add_config_info manifest ix is_multi_config config_types)
    ...
    if (is_library AND is_executable)
        # probaly should fix this before merging and additionally fix multiple binaries...
        message(WARNING "Crates which have both a library and a binary are currently
            not supported by corrosion.")
    endif()
endfunction()
